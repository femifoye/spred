                                ...
                                <div class="admin-view-grid av-grid">
                                    ...
                                    <div class="av-actions">
                                        <div class="edit-action">
                                            <a href="{{route('admin.polls.edit', $poll)}}"><h6>Edit</h6></a>
                                        </div>
                                        <div class="delete-action">
                                            <a href="/" class="btn" onclick="event.preventDefault();
                                                     document.getElementById('delete').submit();"><h6>Delete</h6></a>
                                            <form id="delete" method='POST' action="{{route('admin.polls.destroy', $poll)}}" style="display:none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
